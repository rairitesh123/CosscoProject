...
Particle = function () {
  function Particle(canvas, progress) {_classCallCheck(this, Particle);
    ...
    this.color = random > .2 ? "#d8002c" : "#f08635";
    this.radius = random > .8 ? Math.random() * 2 : this.radius;
    this.color = random > .8 ? "#ff7dee" : this.color;
